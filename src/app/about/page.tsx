  ...
  return (
    <div className="reading page">
      ...
      <section className="section">
        ...
        <p>
          一つの回答が対応する気質ごとに1件を数えます。重みはすべて1で、割合や確率は表示しません。食べ方・好み・作業・見方の4問では、文献の類似関係に従って二つの気質に同時に一致する場合があります。六気質それぞれに最大5問の加点機会があります。
        </p>
        <p>
      ...
      <section className="section">
        <h2>日常の場面から、直接たずねる</h2>
        <p>
          足の上げ下げを別の行動から推定せず、原典にある食べ方・作業・対象の見方などを、日常の場面の質問に置き換えています。選択肢は問ごとに固定の異なる並びにし、毎回同じ位置を選べば同じ気質に加点される構成を避けています。
        </p>
        <p>
          回答のよしあしを印象づける語を減らしましたが、分類を推測できないことや、回答の偏りが減ることを検証した質問票ではありません。原典の意味を変えて選択肢を魅力的にすることはしていません。
        </p>
      </section>
      <section className="section">
        <h2>文献自体の留保も伝える</h2>
